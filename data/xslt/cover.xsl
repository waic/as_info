...
<p>「<a href="http://waic.jp/docs/jis2010/as.html">アクセシビリティ・サポーテッド検証結果</a>」は、必要に応じて随時更新されていく予定である。アクセシビリティ・サポーテッドであるかどうかを判断する際には、その時点での最新の検証結果を参照すること。なお、本文書を作成している時点での最新版は2014年3月版である。</p>
...
<tr>
<td><a href="G115-1.html">G115-1</a></td>
<td class="warn">要注意</td>
<td>見解削除</td>
</tr>
</table>

<h4>7.2.1.1 キーボード操作に関する達成基準</h4>
...
<h4>7.2.4.1 ブロックスキップに関する達成基準</h4>
...
<h4>7.4.1.2 プログラムで解釈可能な識別名，役割及び設定可能な値に関する達成基準</h4>
...
<h4>7.1.4.4 テキストのサイズ変更に関する達成基準</h4>
